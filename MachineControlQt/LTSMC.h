...
//回原点状态，status：0-未完成，1-完成
SMC_API short __stdcall smc_get_home_result(WORD ConnectNo,WORD axis,WORD* status);
...
//连续插补状态
SMC_API short __stdcall smc_conti_get_run_status(WORD ConnectNo,WORD Crd);
...
SMC_API short __stdcall smc_conti_set_pause_output(WORD ConnectNo,WORD Crd,WORD action,long mask,long status);
SMC_API short __stdcall smc_conti_get_pause_output(WORD ConnectNo,WORD Crd,WORD* action,long* mask,long* status);
//连续插补特殊功能
...
SMC_API short __stdcall smc_read_inbit_ex(WORD ConnectNo,WORD bitno,WORD *status);
SMC_API short __stdcall smc_read_outbit_ex(WORD ConnectNo,WORD bitno,WORD *status);
SMC_API short __stdcall smc_read_inport_ex(WORD ConnectNo,WORD portno,DWORD *status);
SMC_API short __stdcall smc_read_outport_ex(WORD ConnectNo,WORD portno,DWORD *status);
...
SMC_API short __stdcall smc_read_sevon_pin_ex(WORD ConnectNo,WORD axis,WORD *status);
SMC_API short __stdcall smc_read_erc_pin_ex(WORD ConnectNo,WORD axis,WORD *status); 
SMC_API short __stdcall smc_read_alarm_pin_ex(WORD ConnectNo,WORD axis,WORD *status);
SMC_API short __stdcall smc_read_inp_pin_ex(WORD ConnectNo,WORD axis,WORD *status);
SMC_API short __stdcall smc_read_org_pin_ex(WORD ConnectNo,WORD uiaxis,WORD *status);
SMC_API short __stdcall smc_read_elp_pin_ex(WORD ConnectNo,WORD uiaxis,WORD *status);
SMC_API short __stdcall smc_read_eln_pin_ex(WORD ConnectNo,WORD uiaxis,WORD *status);
SMC_API short __stdcall smc_read_emg_pin_ex(WORD ConnectNo,WORD uiaxis,WORD *status);
SMC_API short __stdcall smc_read_ez_pin_ex(WORD ConnectNo,WORD axis,WORD *status);
SMC_API short __stdcall smc_read_rdy_pin_ex(WORD ConnectNo,WORD axis,WORD *status);
/*********************************************************************************************************
位置比较
*********************************************************************************************************/
//单轴位置比较		 
...
SMC_API short __stdcall smc_hcmp_get_current_status_unit(WORD ConnectNo,WORD hcmp,long *remained_points,double *current_point,long *runned_points); 
...
SMC_API short __stdcall smc_hcmp_2d_get_current_status(WORD ConnectNo,WORD hcmp,int *remained_points,double *x_current_point,double *y_current_point,int *runned_points,WORD *current_status,WORD *current_outbit); 
...
SMC_API short __stdcall smc_get_ain_status(WORD ConnectNo,WORD channel);
SMC_API short __stdcall smc_set_ain_status(WORD ConnectNo,WORD channel);
...
U盘文件管理
*********************************************************************************************************/
SMC_API short __stdcall smc_udisk_get_status(WORD ConnectNo,WORD *status);
...
SMC_API short __stdcall smc_basic_status(WORD ConnectNo, WORD* State);
...
SMC_API short __stdcall smc_gcode_status(WORD ConnectNo,  WORD* State);
...
SMC_API short __stdcall smc_gcode_set_step_status(WORD ConnectNo,WORD status);
SMC_API short __stdcall smc_gcode_get_step_status(WORD ConnectNo,WORD *status);
...
//读取EtherCAT轴状态
SMC_API short __stdcall nmcs_get_axis_status_machine(WORD ConnectNo,WORD axis, WORD* Axis_StateMachine);
...
SMC_API short __stdcall nmcs_set_axis_io_out(WORD ConnectNo,WORD axis,DWORD  iostatus);
...
SMC_API short __stdcall nmcs_get_log_status(WORD ConnectNo,WORD chan, DWORD* status);
